...
*/
        ...
        writeBinary: function (data,lenData, success, failure) {
               ...
               //      data = data.buffer;
               //  }
               //  console.log("entra a writeBinary");

                cordova.exec(success, failure, "BluetoothSerial", "writebinary", [data,lenData]);
            },

    // calls the success callback when new data is available
    subscribe: function (success, failure) {
        cordova.exec(success, failure, "BluetoothSerial", "subscribe", []);
    },
